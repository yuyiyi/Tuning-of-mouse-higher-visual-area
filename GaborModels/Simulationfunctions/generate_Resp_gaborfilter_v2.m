function [resp, untuneGain] = generate_Resp_gaborfilter_v2(stim, gparams, simpara, simplecell, complexcell, dirSelectiveCell, withLocalNormalization)
resp = [];
filtsize = simpara.filtsize;
t_intgrat = simpara.t_intgrat;
[SimpleUnit0, SimpleUnit90, gparams] = make3dgabor_V3([filtsize, filtsize, t_intgrat], gparams);
if simplecell
...
if nargin>6    
    resp_untuned = untunedcomponent_v2(stim, simpara, gparams);
