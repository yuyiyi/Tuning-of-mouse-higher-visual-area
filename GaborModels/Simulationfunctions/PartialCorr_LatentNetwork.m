function [P, D, h] = PartialCorr_LatentNetwork(extras, NetworkDegree_bin, PartialCorr_threshold)

C = diag(extras.indep_vars)+ extras.loading_matrix*extras.loading_matrix';
